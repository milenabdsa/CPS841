...
confusionPlotFilename = 'thermometer8_' + classes + '.png'
...
filename = 'thermometer8+' + classes + '.txt'
...
X = pickle.load( open( "thermometer8X.p", "rb" ) )
y = pickle.load( open( "thermometer8y.p", "rb" ) )
X_new = []
y_new = []
